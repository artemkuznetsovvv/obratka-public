...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[14rem] max-w-[24rem] overflow-hidden rounded-xl border border-border-subtle bg-card p-1 shadow-lg text-text-primary',
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-state-active-bg focus:text-brand',
      'data-[highlighted]:bg-state-active-bg data-[highlighted]:text-brand',
